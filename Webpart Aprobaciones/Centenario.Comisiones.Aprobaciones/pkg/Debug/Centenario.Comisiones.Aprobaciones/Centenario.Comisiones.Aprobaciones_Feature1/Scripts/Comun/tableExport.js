    ...
    $.fn.extend({
        tableExport: function (options) {
            var defaults = {
                ...
                escape: false,
                excelstyles: ['width', 'height', 'background-color', 'color', 'border-bottom-color',
                'border-bottom-style', 'border-bottom-width', 'border-top-color',
                'border-top-style', 'border-top-width', '-moz-border-radius', '-webkit-border-radius', 'border-radius',
                'border-left-color', 'border-left-style', 'border-left-width',
                'border-right-color', 'border-right-style', 'border-right-width',
                'font-family', 'font-size', 'font-weight', 'text-align'], // e.g. ['border-bottom', 'border-top', 'border-left', 'border-right']
                    ...
                    $row.each(function (colIndex) {
                        if ($(this).data("tableexport-display") == 'always' ||
                            ...
                            if (isColumnIgnored($row, colIndex) == false) {
                                if ($(this)[0].textContent != "Op" && $(this)[0].textContent != "Opciones" && $(this)[0].textContent != "Tipo documento" && $(this)[0].textContent != "Aprobar") {
            ...
            function parseString(cell, rowIndex, colIndex) {
                ...
                if (cell != null) {
                    ...
                    if ($(cell).html().indexOf("href") != -1 && $(cell).html().indexOf("Opciones") == -1 && $(cell).html().indexOf("Tipo documento") == -1 && $(cell).html().indexOf("Aprobar") == -1) {
                        result = "<div style='width: 20px; height: 20px; -moz-border-radius: 50%; -webkit-border-radius: 50%; border-radius: 50%; background-color: #5cb85c;'>Si</div>";
                    }
                }
