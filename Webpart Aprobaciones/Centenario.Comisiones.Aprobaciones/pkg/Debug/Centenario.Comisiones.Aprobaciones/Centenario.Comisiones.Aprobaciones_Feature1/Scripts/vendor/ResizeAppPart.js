...
Communica.Part = {
    ...
    adjustSize: function () {
        ...
        $('div.modal-dialog').each(function () {
            ...
            if (thisH > maxHeightPopup) { maxHeightPopup = thisH; }
        });
        //alert(maxHeight);
        var step = 30, // the recommended increment step is of 30px. Source:

            //width = $('body').width() + 40,        // the App Part width
            height = $('body').height() + 40,  // the App Part height
        ...
        if (this.previousHeight !== height || this.firstResize === true) {
            ...
            resizeMessage = resizeMessage.replace("{Height}", newHeight + 80);
