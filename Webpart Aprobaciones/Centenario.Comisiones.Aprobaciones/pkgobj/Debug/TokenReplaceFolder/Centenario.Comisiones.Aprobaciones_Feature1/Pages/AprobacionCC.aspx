...
<html>
<head>
    <title>Cobranzas - Aprobación de comisiones</title>
    ...
    <script src="../Scripts/Pages/AprobacionCC.js"></script>
</head>
<body>
    <div id="cargando">
        <div>
        ...
        <div class="content">
            <div class="block">
                <div class="block-header">
                    <h3 class="block-title">Aprobación de Comisiones</h3>
                </div>
                <div class="block-content">
                                ...
                                <table id="table-comisiones"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="w-10" data-field="Ejecutivo.Title" data-align="center">Ejecutivo</th>
                                            ...
                                            <th class="w-10" data-field="TotalComision" data-align="center" data-formatter="tableFormats.FormatDecimal">Total Comisión</th>
                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            <div class="col-xs-12">
                                <button class="btn btn-minw btn-rojo" id="btnAprobar" type="button">
                                    Aprobar
                                </button>
                                <button class="btn btn-minw btn-rojo2" id="btnRechazar" type="button">
                                    Rechazar
                                </button>
                                <%--<button class="btn btn-minw btn-rojo2" type="button" data-dismiss="modal">
                                    Cancelar
                                </button>--%>
                            </div>
                        </div>
