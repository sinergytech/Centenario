...
exports.CsomRouter = void 0;
var BasicRouter_1 = require("../BasicRouter");
var headers_1 = require("../../utils/headers");
var CsomRouter = (function (_super) {
    __extends(CsomRouter, _super);
    function CsomRouter(context, settings) {
        ...
        _this.router = function (req, res) {
            ...
            req.on('end', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    headers = headers_1.getHeaders(req.headers);
                    return [2, this.sp.fetch(endpointUrl, { method: 'POST', headers: headers, body: body })
...
exports.CsomRouter = CsomRouter;
//# sourceMappingURL=csom.js.map