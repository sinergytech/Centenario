...
var RestGetRouter = (function (_super) {
    ...
    function RestGetRouter(context, settings) {
        ...
        _this.router = function (req, res) {
            ...
            _this.sp.fetch(endpointUrl, { method: 'GET', headers: headers })
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 2:
                            ...
                            if (typeof ((_a = body.d) === null || _a === void 0 ? void 0 : _a.__next) === 'string') {
                            ...
                            if ((_c = (_b = body === null || body === void 0 ? void 0 : body.d) === null || _b === void 0 ? void 0 : _b.__metadata) === null || _c === void 0 ? void 0 : _c.uri) {
                                body.d.__metadata.uri = this.url.proxyEndpoint(body.d.__metadata.uri);
                            }
                            return [2, new node_fetch_1.Response(JSON.stringify(body), r)];
                        case 3:
                            ex_1 = _d.sent();
                ...
                .then(function (r) { return _this.handlers.response(res)(r, function (resp) {
                if (isDoc) {
                    return resp.buffer();
                }
                return resp.text();
