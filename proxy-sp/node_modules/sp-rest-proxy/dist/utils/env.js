...
var loadPageContext = function (proxyEndpoint, timeout, tries) {
    if (timeout === void 0) { timeout = 100; }
    if (tries === void 0) { tries = 50; }
    return __awaiter(void 0, void 0, void 0, function () {
        var apiEndpoint_1, getWebInfo, getSiteInfo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (typeof _spPageContextInfo !== 'undefined') {
                        return [2, _spPageContextInfo];
                    }
                    if (exports.isLocalhost) {
                        apiEndpoint_1 = proxyEndpoint || window.location.origin;
                        getWebInfo = function () {
                        ...
                        return [2, Promise.all([getWebInfo(), getSiteInfo()]).then(function (_a) {
                                ...
                                return _spPageContextInfoFake;
                            })];
                    }
                    SP.SOD.executeFunc('sp.js', 'SP.ClientContext', function () { });
                    return [4, misc_1.waitForCondition(function () { return typeof _spPageContextInfo !== 'undefined'; }, timeout, tries)];
                case 1:
                    _a.sent();
                    return [2, _spPageContextInfo];
            }
...
exports.loadPageContext = loadPageContext;
